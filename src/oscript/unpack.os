...
Функция СинхронизироватьХранилищеКонфигурацийСГит(СтруктураПараметров) Экспорт
	...
	МаксимальнаяВерсияДляРазбора = ОпределитьМаксимальнуюВерсию(ТаблицаИсторииХранилища, ТекущаяВерсия, МаксимальнаяВерсия);	
...
Функция ОпределитьМаксимальнуюВерсию(Знач ТаблицаИсторииХранилища, Знач ТекущаяВерсия, Знач МаксимальнаяВерсия)
